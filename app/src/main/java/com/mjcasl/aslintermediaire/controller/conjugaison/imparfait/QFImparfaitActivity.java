...
public class QFImparfaitActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private ImgBank generateQuestions() {
        ...
        ImgQuestion imgQuestion5 = new ImgQuestion("Hier, il ______ de la fièvre.", R.drawable.fievre,
                Arrays.asList("Était", "Étais", "Avait", "Avais"),
                2);

        ImgQuestion imgQuestion6 = new ImgQuestion("Autrefois, j'_______ un tricycle rouge.",R.drawable.tricycle,
                Arrays.asList("Étais", "Avais", "Était", "Avait"),
                1);

        ImgQuestion imgQuestion7 = new ImgQuestion(" L'an dernier, tu ______ déjà un bon judoka.",R.drawable.judoka,
                Arrays.asList("Avaient", "Étaient", "Avais", "Était"),
                3);

        ImgQuestion imgQuestion8 = new ImgQuestion("En ce temps là, vous ______ un jardin plein de fleurs.",R.drawable.brouette,
                Arrays.asList("Avais", "Aviez", "Était", "Étiez"),
                2);

        ImgQuestion imgQuestion9 = new ImgQuestion("Sagement,______ écoutaient une histoire.", R.drawable.ecouterhistoire,
                Arrays.asList("Je", "Tu", "Ils", "Elles"),
                2);

        ImgQuestion imgQuestion10 = new ImgQuestion("Quand j'étais petit, ______ sautais dans les flaques.",R.drawable.sauterflaque,
                Arrays.asList("Il", "Elle", "Nous", "Je"),
                3);

        ImgQuestion imgQuestion11 = new ImgQuestion("J'ai vu que _______ parlais avec une copine.",R.drawable.eleves2,
                Arrays.asList("Il", "Tu", "Ils", "Vous"),
                1);

        ImgQuestion imgQuestion12 = new ImgQuestion("Avant ______ voyagions en train.",R.drawable.train,
                Arrays.asList("Ils", "Tu", "Je", "Nous"),
                3);


        ImgQuestion imgQuestion13 = new ImgQuestion("Ma mère ______ une paire de chaussures.",R.drawable.acheterchaussures,
                Arrays.asList("Achetais", "Achetez", "Achetait", "Achetaient"),
                2);

        ImgQuestion imgQuestion14 = new ImgQuestion("Il ______ des papillons.",R.drawable.chasserpapillon,
                Arrays.asList("Attrapais", "Attrapait", "Attrapez", "Attraper"),
                1);

        ImgQuestion imgQuestion15 = new ImgQuestion("Vous ______ aux cartes toute la soirée.",R.drawable.jouercartes,
                Arrays.asList("Jouiez", "Jouer", "Jouez", "Jouier"),
                0);

        ImgQuestion imgQuestion16 = new ImgQuestion("La jeune fille ______ comme une championne.",R.drawable.championne,
                Arrays.asList("Patinais", "Patinait", "Patiner", "Patinez"),
                1);

        ImgQuestion imgQuestion17 = new ImgQuestion("Nous (aller) à la mer chaque matin avec le club de plongée.",R.drawable.logo_mjc,
                Arrays.asList("Allons", "Alliont", "Allions", "Allion"),
                2);

        ImgQuestion imgQuestion18 = new ImgQuestion("Je (revenir) chaque jour en autobus.",R.drawable.logo_mjc,
                Arrays.asList("Revener", "Revenais", "Revenez", "Revenait"),
                1);

        ImgQuestion imgQuestion19 = new ImgQuestion(" Vous (être) au bord des larmes en apprenant la nouvelle.",R.drawable.logo_mjc,
                Arrays.asList("Etiez", "Etier", "Etier", "Etez"),
                0);

        ImgQuestion imgQuestion20 = new ImgQuestion("Tu (attendre) cette promotion avec impatience.",R.drawable.logo_mjc,
