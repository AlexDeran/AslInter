...
public class ExEtreAvoirImparfaitActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private ImgBank generateQuestions() {
        ...
        ImgQuestion imgQuestion2 = new ImgQuestion("Mon chien à des puces. =>                               Mon chien ______ des puces.",R.drawable.chienpuces,
        ...
        ImgQuestion imgQuestion5 = new ImgQuestion("L'été dernier, nous ______ en vacances à la mer.",R.drawable.mer,
                Arrays.asList("Étions", "Étiez", "Avions", "Aviez"),
                0);

        ImgQuestion imgQuestion6 = new ImgQuestion("Hier soir, j'______ hâte d'aller me coucher.",R.drawable.reveiller,
                Arrays.asList("Était", "Avais", "Avait", "Étais"),
                1);

        ImgQuestion imgQuestion7 = new ImgQuestion("Hier, il ______ de la fièvre.", R.drawable.fievre,
        ...
        ImgQuestion imgQuestion9 = new ImgQuestion(" L'an dernier, tu ______ déjà un bon judoka.",R.drawable.judoka,
                Arrays.asList("Avaient", "Étaient", "Avais", "Était"),
                3);

        ImgQuestion imgQuestion10 = new ImgQuestion("En ce temps là, vous ______ un jardin plein de fleurs.",R.drawable.brouette,
